...
today.getDate() >= 20 ? monthSelect.insertAdjacentHTML('beforeend', `${actualMonthShortForm}`) : monthSelect.insertAdjacentHTML('beforeend', `${beforeMonthShortForm} , ${actualMonthShortForm}`) ;